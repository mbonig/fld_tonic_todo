# Matthew Bonig's Todo Coding Exercise

The HelloTonic.com coding exercise. Built from an angular2+webpack starter (https://github.com/preboot/angular-webpack).

### Quick start

```bash
# clone our repo
$ git clone https://github.com/mbonig/fld_tonic_todo.git mbonig-todo
